...
export const ScheduleMeeting = ({
  ...
  const commonTimeslots = flattenCommonTimeslots(
    findCommonDateTimes(attendeeAvailabilities)
  );
  ...
  return commonTimeslots ? (
    <div className="sticky top-0 pt-2 max-h-screen overflow-y-auto">
      ...
      {commonTimeslots.length > 1 ? (
        ...
        <div> There are no common timeslots yet :( </div>
      )}
      <ConfirmationModal
        isOpen={isDialogOpen}
